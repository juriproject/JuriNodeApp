...
CONTROLLER_PUBLIC_KEY=$CONTROLLER_PUBLIC_KEY CONTROLLER_PRIVATE_KEY=$CONTROLLER_PRIVATE_KEY MAX_USER_COUNT=$USER_COUNT node ../controllerNode/setupProxyForNewRound.js
